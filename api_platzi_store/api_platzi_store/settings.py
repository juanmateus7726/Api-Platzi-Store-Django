...
SECRET_KEY = 'django-insecure-dd-1lkkvv4e8qfpy5-wdrch!v^as8@0at6*y%92_eby_ycktd5'
...
INSTALLED_APPS = [
    ...
    'accounts',
    'rest_framework',
    'rest_framework.authtoken', # Para autenticacion con token
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',
            BASE_DIR / 'templates', # Templates de accounts
            ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'masteruser',
        'PASSWORD': '1053606690Juan',
        'HOST': 'db-platzi-store-database.cnm4o4ekqy87.us-east-2.rds.amazonaws.com',
        'PORT': '5432'
    }
}
...
CUSTOM_API_BASE_URL = "http://127.0.0.1:8000/accounts/api/"
